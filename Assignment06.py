...
# RShip,11/23/20,Modified code to complete assignment 6
# ---------------------------------------------------------------------------- #
...
class Processor:
    ...
    def add_data_to_list(task, priority, list_of_rows):
        # TODO: Add Code Here!                                    #DONE #3
        row = {'Task': task, 'Priority': priority}
        list_of_rows.append(row)
        return list_of_rows, 'Success'

    @staticmethod
    def remove_data_from_list(task, lst_of_rows):
        # TODO: Add Code Here!                                    #DONE #6
        for row in lst_of_rows:
            if row['Task'] == task:
                lst_of_rows.remove(row)  # question
        return lst_of_rows, 'Success'

    @staticmethod
    def write_data_to_file(file_name, list_of_rows):
        # TODO: Add Code Here!                                     #DONE #1
...
class IO:
    ...
    def input_new_task_and_priority():
        # TODO: Add Code Here!                                    #DONE 4
        task = str(input('please enter a Task: '))
        priority = str(input('please enter a Priority: '))
        return task, priority

    @staticmethod
    def input_task_to_remove():
        # TODO: Add Code Here!                                    #DONE 7
        task = str(input("Choose a task to remove: "))
        return task
